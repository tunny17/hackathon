        ...
        <div className='flex flex-row justify-between items-center lg:w-[57%]'>
          ...
          <div className='relative w-[40%]'>
            <input
              ...
              id=''
              placeholder='Search...'
              className='search-input hidden w-full lg:block border bg-white dark:text-white border-[#DADDDD] rounded-full outline-none px-9 pt-1 pb-2 placeholder:text-[13px]'
            />
            <img
              src='/search-icon.svg'
              alt=''
